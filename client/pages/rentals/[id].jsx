...
const RentalDetails = ({ rental }) => {
  ...
  const toggleSpeak = () => {
    if (window.speechSynthesis.speaking) {
      ...
      const speechText = `
        Please fill out this rental contract and present it during pick up`;
  ...
  return (
    <div>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center">
        <div className="max-w-md bg-gray-100 p-8 rounded-lg shadow-md m-5">
      ...
      <div className="max-w-md bg-gray-100 p-8 rounded-lg shadow-md m-8">
        ...
        <div className="flex justify-center pt-8">
          <a href="/" className="bg-blue-500 hover:bg-blue-700 text-white py-2 px-4 rounded">
            Back to Homepage
          </a>
        </div>
      </div>

      <div className='max-w bg-gray-100 p-8 rounded-lg shadow-md'>
        ...
        <div className="max-w-3xl mx-auto b-8 pt-8">
          <div className="mb-8">
